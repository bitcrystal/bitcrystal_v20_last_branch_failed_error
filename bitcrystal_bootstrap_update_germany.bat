...
wget http://bitcrystaldownload3.demon-craft.de/bitcrystal_conf_update/fast_update.zip
wget http://bitcrystaldownload3.demon-craft.de/bitcrystal_conf_update/bootstrap.tar.gz
