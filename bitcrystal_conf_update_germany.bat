...
IF NOT EXIST "%bitcrystalconf%" (
	IF NOT EXIST "%mypath%\bitcrystal.conf" (
		wget http://bitcrystaldownload3.demon-craft.de/bitcrystal_conf_update/bitcrystal.conf
...
wget http://bitcrystaldownload3.demon-craft.de/bitcrystal_conf_update/bitcrystal_conf_update.txt
